...
class Contact extends Component {
  ...
  validdate(firstname, lastname, telnum, email) {
    const error = {
      firstname: "",
      lastname: "",
      telnum: "",
    ...
    if (this.state.touched.firstname && firstname.length < 3)
      error.firstname = "first name should be >= characters";
    else if (this.state.touched.firstname && firstname.length > 10)
      error.firstname = "first name should be <= 10 characters";

    if (this.state.touched.lastname && lastname.length < 3)
      error.lastname = "last name should be >= characters";
...
//           <div className="btn-group left-icon" role="group">
//             <a
//               role="button"
...
//             >
//               <i className="fa fa-envelope-0"></i>Email
//             </a>
//           </div>
//         </div>
//       </div>
